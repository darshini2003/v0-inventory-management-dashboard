      ...
      >
        <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
          <div className="flex items-center flex-shrink-0">
            ...
            <span className="text-xl font-bold text-white ml-2">StockSync</span>
          </div>
          ...
          <div className="hidden md:flex items-center justify-center flex-grow space-x-6 lg:space-x-8 px-4">
            ...
            >
              ...
              <DropdownMenu isOpen={openDropdown === "integrations"}>
                <DropdownItem href="#">Supabase</DropdownItem>
                <DropdownItem href="#">PostgreSQL</DropdownItem>
                <DropdownItem href="#">Stripe</DropdownItem>
                <DropdownItem href="#">Webhooks</DropdownItem>
                <DropdownItem href="#">API Access</DropdownItem>
              </DropdownMenu>
            </div>
          ...
          <div className="flex items-center flex-shrink-0 space-x-4 lg:space-x-6">
            <NavLink href="/auth/login" className="hidden md:inline-block">
              Sign in
            </NavLink>

            <motion.a
              href="/auth/register"
              className="bg-[#0CF2A0] text-black px-4 py-[6px] rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md"
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="flex flex-col items-center space-y-4 px-6">
                ...
                <NavLink href="/auth/login" onClick={() => setIsMobileMenuOpen(false)}>
                  Sign in
                </NavLink>
              </div>
            </motion.div>
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
        <motion.div variants={bannerVariants} initial="hidden" animate="visible" className="mb-6">
          <ShinyText
            ...
            className="bg-black/40 border border-gray-700 text-[#0CF2A0] px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-pointer hover:border-[#0CF2A0]/50 transition-colors backdrop-blur-sm"
          />
        </motion.div>
        ...
        >
          ...
          <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
            <RotatingText
              texts={["Intelligence", "Precision", "Analytics", "Automation", "Insights"]}
        ...
        >
          Track inventory levels, manage orders, analyze trends, and optimize your supply chain with real-time insights
        ...
        >
          <input
            ...
            className="flex-grow w-full sm:w-auto px-4 py-2 rounded-md bg-black/40 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0CF2A0] focus:border-transparent transition-all backdrop-blur-sm"
          />
          <motion.button
            type="submit"
            className="w-full sm:w-auto bg-[#0CF2A0] text-black px-5 py-2 rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md flex-shrink-0"
            whileHover={{ scale: 1.03, y: -1 }}
            whileTap={{ scale: 0.97 }}
            transition={{ type: "spring", stiffness: 400, damping: 15 }}
          >
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-gray-400">
            <span className="flex items-center whitespace-nowrap">Supabase</span>
            <span className="flex items-center whitespace-nowrap">PostgreSQL</span>
            <span className="flex items-center whitespace-nowrap">Stripe</span>
            <span className="flex items-center whitespace-nowrap">Webhooks</span>
            <span className="flex items-center whitespace-nowrap">REST API</span>
          </div>
        </motion.div>
        ...
        >
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-[#0CF2A0]/20 to-blue-500/20 rounded-lg blur-xl opacity-75 group-hover:opacity-100 transition-opacity duration-300"></div>
            <img
              src="/placeholder.svg?height=640&width=1024"
              alt="StockSync Dashboard Preview - Real-time inventory management interface"
              width={1024}
              height={640}
              className="relative w-full h-auto object-contain rounded-lg shadow-2xl border border-gray-700/50 bg-black/20 backdrop-blur-sm"
              loading="lazy"
            />
          </div>
        </motion.div>
